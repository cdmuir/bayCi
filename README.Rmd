...
[![Build Status](https://travis-ci.org/cdmuir/bayci.svg?branch=master)](https://travis-ci.org/cdmuir/bayCi)
...
```{r child = 'vignettes/basic-racir.Rmd'}
```
...
* Please [report any issues or bugs](https://github.com/cdmuir/bayCi/issues).
* License: MIT
