  ...
  braycir_template %>%
    stringr::str_replace(
      ...
      replacement = glue::glue(
        ...
        l = ci_init_empty$low[ci_init_empty$parameter == "b0"],
        u = ci_init_empty$high[ci_init_empty$parameter == "b0"]
      )
    ) %>%
    stringr::str_replace(
      ...
      replacement = glue::glue(
        ...
        l = ci_init_empty$low[ci_init_empty$parameter == "b1"],
        u = ci_init_empty$high[ci_init_empty$parameter == "b1"]
      )
    ) %>%
    stringr::str_replace(
